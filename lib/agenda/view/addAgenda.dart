...
class _AddAgendaState extends State<AddAgenda> {
  ...
  // FocusNode _tanggalAwal = FocusNode();
  // FocusNode _tanggalAkhir = FocusNode();
  void tanyakeluar() {
    if (isSaving) {
              ...
              onTap: (startLoading, stopLoading, btnState) async {
                if (btnState == ButtonState.Idle) {
                  ...
                  if (_key.currentState.saveAndValidate()) {
                    ...
                    startLoading();
                    await postData(
                      url: urlApi.addAgenda,
                      data: {
                        "nama_kegiatan":
                            _key.currentState.value['nama_kegiatan'],
                        "keterangan": _key.currentState.value['keterangan'],
                        "tgl_awal": _key.currentState.value['tanggal_awal'],
                        "tgl_akhir": _key.currentState.value['tanggal_akhir'],
